...
import { View, TextInput, Text, StyleSheet, Image, ImageBackground, Dimensions, AsyncStorage, ScrollView, TouchableOpacity, Alert } from 'react-native'
...
class LaundreeScreen extends Component {
    ...
    onBookPress = () => {
        ...
        axios
            ...
            .post(
                'api.vasketid.se/laundree1/public/booking',
                {
                    rid: 1,
